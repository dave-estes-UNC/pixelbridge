...
namespace nddi {
    ...
    public:
        ...
        void setValue(unsigned int location, int value) {
            ...
            costModel_->registerMemoryCharge(INPUT_VECTOR_COMPONENT, WRITE_ACCESS, values_ + location, 4);
        ...
        int getValue(unsigned int location) {
            ...
            costModel_->registerMemoryCharge(INPUT_VECTOR_COMPONENT, READ_ACCESS, values_ + location, 4);
