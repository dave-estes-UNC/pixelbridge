 ...
 */
int16_t* MultiDctTiler::ConvertToSignedPixels(uint8_t* buffer, size_t width, size_t height) {
 ...
 */
int16_t* MultiDctTiler::DownSample(size_t factor, int16_t* buffer, size_t width, size_t height) {
 ...
 */
int16_t* MultiDctTiler::UpSample(size_t factor, int16_t* buffer, size_t width, size_t height) {
...
size_t MultiDctTiler::EstimateCost(bool isTrim, vector< vector< vector<uint64_t> > > &coefficientsForScale, size_t c, size_t delta, size_t planes) {
...
void MultiDctTiler::CalculateSnapCoefficientsToZero(vector< vector< vector<uint64_t> > > &coefficientsForScale, size_t c, size_t &delta, size_t &planes) {
 ...
 */
void MultiDctTiler::SnapCoefficientsToZero(vector< vector< vector<uint64_t> > > &coefficientsForScale, size_t c, size_t delta, size_t planes) {
...
void MultiDctTiler::CalculateTrimCoefficients(vector< vector< vector<uint64_t> > > &coefficientsForScale, size_t c, size_t &delta, size_t &planes) {
 ...
 */
size_t MultiDctTiler::TrimCoefficients(vector<uint64_t> &coefficients, size_t i, size_t j, size_t c, size_t delta, size_t planes) {
 ...
 */
size_t MultiDctTiler::EstimateCostForZeroingPlanes(vector< vector< vector<uint64_t> > > &coefficientsForScale, size_t c, size_t first, size_t last) {
 ...
 * are updated.
 */
void MultiDctTiler::ZeroPlanes(vector< vector< vector<uint64_t> > > &coefficientsForScale, size_t c) {
 ...
 */
void MultiDctTiler::AdjustFrame(int16_t* buffer, int16_t* renderedBuffer, size_t width, size_t height) {
#ifndef NO_OMP
#pragma omp parallel for
#endif
    for (size_t i = 0; i < (width * height * 3); i++) {
