...
namespace nddi {
    ...
    public:
        ...
        void putScaler(unsigned int x, unsigned int y, unsigned int p, int scaler) {
            ...
            costModel_->registerMemoryCharge(COEFFICIENT_PLANE_COMPONENT, WRITE_ACCESS, &scalers_[p * width_ * height_ + y * width_ + x], BYTES_PER_SCALAR, 0);
        ...
        int getScaler(unsigned int x, unsigned int y, unsigned int p) {
            ...
            costModel_->registerMemoryCharge(COEFFICIENT_PLANE_COMPONENT, READ_ACCESS, &scalers_[p * width_ * height_ + y * width_ + x], BYTES_PER_SCALAR, 0);
