// TODO(CDE): Rip this copied implementation out and replace.
//            Don't forget to clamp the tiles and don't try to write past a dimension.
__kernel void copyPixelTiles(__global int* inputVector,
